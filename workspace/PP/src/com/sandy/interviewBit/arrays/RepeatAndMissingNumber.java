...
public class RepeatAndMissingNumber {
	...
	public int[] repeatedNumber(final int[] A) {
        ...
        //System.out.println("xor sum = "+xorMandR);
        long setBitNum = findSetBitNumber(xorMandR);
        ...
        //System.out.println("xorSetNums = " + xorSetNums);
        //System.out.println("xorUnsetNums = " + xorUnsetNums);
        ...
        if(repeatingFound) {
        	output[0] = (int)xorSetNums;
        	output[1] = (int)xorUnsetNums;
        } else {
        	output[0] = (int)xorUnsetNums;
        	output[1] = (int)xorSetNums;
        }
	...
	public long findSetBitNumber(long num) {
		long res = (num & (~(num-1)));
		return res;
	}
